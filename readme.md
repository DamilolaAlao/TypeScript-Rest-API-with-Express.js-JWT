...
|| `GET`    | `/api/users/me`           | Returns the authenticated user's profile (requires a valid token; password is excluded).                               |
|| `GET`    | `/api/posts`              | Returns the posts (requires a valid token).                                            |
